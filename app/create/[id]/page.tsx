...
import { ArrowRight, Eye, EyeOff, Save, ExternalLink } from 'lucide-react';
      ...
      <div className="sticky top-0 z-50 border-b border-border/60 bg-background/80 backdrop-blur-xl">
        <div className="flex items-center justify-between px-4 h-14 max-w-7xl mx-auto">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-bold text-foreground leading-none">تعديل الصفحة</p>
              {shortId && <p className="text-[10px] text-muted-foreground font-mono mt-0.5">/p/{shortId}</p>}
            </div>
          </div>
          <div className="flex items-center gap-2">
            ...
            {shortId && (
              <button onClick={handleOpenPage} className="ios-press w-9 h-9 rounded-xl bg-secondary border border-border/60 flex items-center justify-center text-muted-foreground hover:bg-muted transition-all">
